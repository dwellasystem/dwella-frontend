      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <Row>
            ...
            <Col>
              <label className="fw-semibold text-secondary" htmlFor="">Unit Number</label>
              <p className="fw-bold">{payment.unit ?? ''}</p>
            </Col>
          </Row>
          
          <Col>
            <label className="fw-semibold text-secondary" htmlFor="">Reference Number</label>
            <p className="fw-bold">{payment.reference_number ?? ''}</p>
          </Col>
